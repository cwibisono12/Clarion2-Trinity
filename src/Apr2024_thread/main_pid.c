...
*/
  ...
  int ab;
  for(ab=0;ab<4096;ab++){
	if((pid_qdc11[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc12[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc13[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc14[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc15[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc16[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc17[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc18[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	...
	if((pid_qdc31[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc32[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc33[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc34[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc35[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc36[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc37[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc38[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc39[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc310[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc311[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc312[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc313[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc314[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	...
	if((pid_qdc51[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc52[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc53[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc54[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc55[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc56[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc57[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc58[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc59[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc510[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc511[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc512[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc513[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc514[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc515[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
	if((pid_qdc516[ab]=(int*)malloc(4096*sizeof(int))) == NULL){
	printf("\nError,memory not allocated\n");
	exit(1);
	}
...
/////////////Variable for Paralel Processing/////  
ARGPARSE4 *pid[64];
for(i=0;i<64;i++){
pid[i]=(ARGPARSE4*) malloc(sizeof(ARGPARSE4));

}
for(i=0;i<64;i++){
pid[i]->xdim=4096;
pid[i]->ydim=4096;
pid[i]->overwrite=overwrite;
}
  
pid[0]->filename = PID_QDC11;
pid[1]->filename = PID_QDC12;
pid[2]->filename = PID_QDC13;
pid[3]->filename = PID_QDC14;
pid[4]->filename = PID_QDC15;
pid[5]->filename = PID_QDC16;
pid[6]->filename = PID_QDC17;
pid[7]->filename = PID_QDC18;
pid[8]->filename = PID_QDC21;
pid[9]->filename = PID_QDC22;

pid[10]->filename = PID_QDC23;
pid[11]->filename = PID_QDC24;
pid[12]->filename = PID_QDC25;
pid[13]->filename = PID_QDC26;
pid[14]->filename = PID_QDC27;
pid[15]->filename = PID_QDC28;
pid[16]->filename = PID_QDC29;
pid[17]->filename = PID_QDC210;
pid[18]->filename = PID_QDC31;
pid[19]->filename = PID_QDC32;
pid[20]->filename = PID_QDC33;
pid[21]->filename = PID_QDC34;
pid[22]->filename = PID_QDC35;
pid[23]->filename = PID_QDC36;
pid[24]->filename = PID_QDC37;
pid[25]->filename = PID_QDC38;
pid[26]->filename = PID_QDC39;
pid[27]->filename = PID_QDC310;
pid[28]->filename = PID_QDC311;
pid[29]->filename = PID_QDC312;
pid[30]->filename = PID_QDC313;
pid[31]->filename = PID_QDC314;
pid[32]->filename = PID_QDC41;
pid[33]->filename = PID_QDC42;
pid[34]->filename = PID_QDC43;
pid[35]->filename = PID_QDC44;
pid[36]->filename = PID_QDC45;
pid[37]->filename = PID_QDC46;
pid[38]->filename = PID_QDC47;
pid[39]->filename = PID_QDC48;
pid[40]->filename = PID_QDC49;
pid[41]->filename = PID_QDC410;
pid[42]->filename = PID_QDC411;
pid[43]->filename = PID_QDC412;
pid[44]->filename = PID_QDC413;
pid[45]->filename = PID_QDC414;
pid[46]->filename = PID_QDC415;
pid[47]->filename = PID_QDC416;
pid[48]->filename = PID_QDC51;
pid[49]->filename = PID_QDC52;
pid[50]->filename = PID_QDC53;
pid[51]->filename = PID_QDC54;
pid[52]->filename = PID_QDC55;
pid[53]->filename = PID_QDC56;
pid[54]->filename = PID_QDC57;
pid[55]->filename = PID_QDC58;
pid[56]->filename = PID_QDC59;
pid[57]->filename = PID_QDC510;
pid[58]->filename = PID_QDC511;
pid[59]->filename = PID_QDC512;
pid[60]->filename = PID_QDC513;
pid[61]->filename = PID_QDC514;
pid[62]->filename = PID_QDC515;
pid[63]->filename = PID_QDC516;
...
*/
//Assigned the arguments for parallel processing//
for(i=0;i<4096;i++){
pid[0]->data[i]=pid_qdc11[i];
pid[1]->data[i]=pid_qdc12[i];
pid[2]->data[i]=pid_qdc13[i];
pid[3]->data[i]=pid_qdc14[i];
pid[4]->data[i]=pid_qdc15[i];
pid[5]->data[i]=pid_qdc16[i];
pid[6]->data[i]=pid_qdc17[i];
pid[7]->data[i]=pid_qdc18[i];
pid[8]->data[i]=pid_qdc21[i];
pid[9]->data[i]=pid_qdc22[i];
pid[10]->data[i]=pid_qdc23[i];
pid[11]->data[i]=pid_qdc24[i];
pid[12]->data[i]=pid_qdc25[i];
pid[13]->data[i]=pid_qdc26[i];
pid[14]->data[i]=pid_qdc27[i];
pid[15]->data[i]=pid_qdc28[i];
pid[16]->data[i]=pid_qdc29[i];
pid[17]->data[i]=pid_qdc210[i];
pid[18]->data[i]=pid_qdc31[i];
pid[19]->data[i]=pid_qdc32[i];
pid[20]->data[i]=pid_qdc33[i];
pid[21]->data[i]=pid_qdc34[i];
pid[22]->data[i]=pid_qdc35[i];
pid[23]->data[i]=pid_qdc36[i];
pid[24]->data[i]=pid_qdc37[i];
pid[25]->data[i]=pid_qdc38[i];
pid[26]->data[i]=pid_qdc39[i];
pid[27]->data[i]=pid_qdc310[i];
pid[28]->data[i]=pid_qdc311[i];
pid[29]->data[i]=pid_qdc312[i];
pid[30]->data[i]=pid_qdc313[i];
pid[31]->data[i]=pid_qdc314[i];
pid[32]->data[i]=pid_qdc41[i];
pid[33]->data[i]=pid_qdc42[i];
pid[34]->data[i]=pid_qdc43[i];
pid[35]->data[i]=pid_qdc44[i];
pid[36]->data[i]=pid_qdc45[i];
pid[37]->data[i]=pid_qdc46[i];
pid[38]->data[i]=pid_qdc47[i];
pid[39]->data[i]=pid_qdc48[i];
pid[40]->data[i]=pid_qdc49[i];
pid[41]->data[i]=pid_qdc410[i];
pid[42]->data[i]=pid_qdc411[i];
pid[43]->data[i]=pid_qdc412[i];
pid[44]->data[i]=pid_qdc413[i];
pid[45]->data[i]=pid_qdc414[i];
pid[46]->data[i]=pid_qdc415[i];
pid[47]->data[i]=pid_qdc416[i];
pid[48]->data[i]=pid_qdc51[i];
pid[49]->data[i]=pid_qdc52[i];
pid[50]->data[i]=pid_qdc53[i];
pid[51]->data[i]=pid_qdc54[i];
pid[52]->data[i]=pid_qdc55[i];
pid[53]->data[i]=pid_qdc56[i];
pid[54]->data[i]=pid_qdc57[i];
pid[55]->data[i]=pid_qdc58[i];
pid[56]->data[i]=pid_qdc59[i];
pid[57]->data[i]=pid_qdc510[i];
pid[58]->data[i]=pid_qdc511[i];
pid[59]->data[i]=pid_qdc512[i];
pid[60]->data[i]=pid_qdc513[i];
pid[61]->data[i]=pid_qdc514[i];
pid[62]->data[i]=pid_qdc515[i];
pid[63]->data[i]=pid_qdc516[i];
}
//////////////////////////////////


for(i=0;i<64;i++){
pthread_create(&thread_id[0],NULL,write_data4dyn_th,(void *) pid[i]);
}
...
/*
 write_data4dyn(PID_QDC11, pid_qdc11, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC12, pid_qdc12, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC13, pid_qdc13, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC14, pid_qdc14, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC15, pid_qdc15, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC16, pid_qdc16, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC17, pid_qdc17, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC18, pid_qdc18, 4096, 4096, overwrite);
 ...
 write_data4dyn(PID_QDC31, pid_qdc31, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC32, pid_qdc32, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC33, pid_qdc33, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC34, pid_qdc34, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC35, pid_qdc35, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC36, pid_qdc36, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC37, pid_qdc37, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC38, pid_qdc38, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC39, pid_qdc39, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC310, pid_qdc310, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC311, pid_qdc311, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC312, pid_qdc312, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC313, pid_qdc313, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC314, pid_qdc314, 4096, 4096, overwrite);
 ...
 write_data4dyn(PID_QDC51, pid_qdc51, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC52, pid_qdc52, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC53, pid_qdc53, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC54, pid_qdc54, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC55, pid_qdc55, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC56, pid_qdc56, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC57, pid_qdc57, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC58, pid_qdc58, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC59, pid_qdc59, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC510, pid_qdc510, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC511, pid_qdc511, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC512, pid_qdc512, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC513, pid_qdc513, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC514, pid_qdc514, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC515, pid_qdc515, 4096, 4096, overwrite);
 write_data4dyn(PID_QDC516, pid_qdc516, 4096, 4096, overwrite);
...
//  double time_taken = ((double) timeinit)/CLOCKS_PER_SEC;
//  printf("Time it takes to write spectra %f seconds\n",time_taken);
