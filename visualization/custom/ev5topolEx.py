...
def ev5topol(fpr,*,dimy=2,dimx=8192,overwrite=0):
	'''
	Function to Generate Linear Polarization Spectra from ev5 file gated on particle and Ex energy.
	Parameter(s):
	...
	with open(fpr,mode='rb') as f:
		while(1):
			...
			if temp == -1:
				...
				if (temp[0][0] == 2 and temp[0][1] == 0) and (temp[0][3] >= 855 and temp[0][3] <=1055): #2p-gated
				...
				if (temp[0][0] == 1 and temp[0][1] == 1) and (temp[0][3] >= 855 and temp[0][3] <=1055): #1p-1a gated
					for i in temp[1].keys():
						#Prompt:
						if (temp[1][i][4] == 1 and temp[1][i][7] == 2) and (i == '3' or i == '4' or i== '9' or i == '10'):
							#Parallel Spectra:
