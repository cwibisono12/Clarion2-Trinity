...
class fitgui:
	...
	def onclick(self,event):
		...
		q=np.where(self.x==int(event.xdata))[0][0]   
    #yq=self.y[q]
	...
	def gauss(self,event):
		...
		backgheight=np.average(self.y[np.where(self.x==int(self.bkgleft))[0][0]:np.where(self.x==int(self.bkgright))[0][0]])
    ...
    #width=(self.x[int(self.xup)-min(self.x)]-self.x[meanfitcenter-min(self.x)])
		width=(self.x[np.where(self.x==int(self.xup))[0][0]]-self.x[z])
		mu0=self.x[z]
		...
		popt,pcov=cvt(lambda x, A, mu, sigma: fitgui.gaussfunc(x,A,mu,sigma,backgheight),self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],self.y[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],p0)
		...
		self.gfit=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],*popt,backgheight),'m',linewidth=1.5)
		for i in range(0,4,1):
	...
	def doubgauss(self,event):	
		...
		popt,pcov=cvt(lambda x, A1, mu1, sigma1, A2, mu2, sigma2: fitgui.gaussdoub(x,A1,mu1,sigma1,A2,mu2,sigma2,backgheight),self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],self.y[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],p0)
		#return popt,backgheight	
		...
		if self.curv3 != None:
			...
			abc6.remove()
		self.curv1=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussdoub(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],*popt,backgheight),'m',linewidth=1.5)
		self.curv2=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],popt[0],popt[1],popt[2],backgheight),'k',linewidth=1.0)
		self.curv3=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],popt[3],popt[4],popt[5],backgheight),'k',linewidth=1.0)
		self.line.figure.canvas.draw()
	...
	def tripgauss(self,event):	
		...
		popt,pcov=cvt(lambda x, A1, mu1, sigma1, A2, mu2, sigma2, A3, mu3, sigma3: fitgui.gausstrip(x,A1,mu1,sigma1,A2,mu2,sigma2,A3,mu3,sigma3,backgheight),self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],self.y[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],p0)
		area1=popt[0]*np.sqrt(2.0*np.pi)*abs(popt[2])
		area2=popt[3]*np.sqrt(2.0*np.pi)*abs(popt[5])
		...
		self.tripg1=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gausstrip(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],*popt,backgheight),'m',linewidth=1.5)
		self.tripg2=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],popt[0],popt[1],popt[2],backgheight),'k',linewidth=1.0)
		self.tripg3=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],popt[3],popt[4],popt[5],backgheight),'k',linewidth=1.0)
		self.tripg4=self.line.axes.plot(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],fitgui.gaussfunc(self.x[np.where(self.x==int(self.xlow))[0][0]:np.where(self.x==int(self.xup))[0][0]],popt[6],popt[7],popt[8],backgheight),'k',linewidth=1.0)
		self.line.figure.canvas.draw()
