...
#C. Wibisono
#v2-- update plot for every 2 minutes 
#v1-- 05/29/2023
...
from custom import projmod as p
from custom import fitgui2 as f
...
def initiate():
	global dimy,dimx,xlow,xup,ylow,yup
	dimy=int(sys.argv[3])
	dimx=int(sys.argv[4])
	xlow=int(sys.argv[5])
	xup=int(sys.argv[6])
...
def project():
	global A11,A12,A13,A14,B21,B22,B23,B24
	global C31,C32,C33,C34,D41,D42,D43,D44
	global E51,E52,E53,E54,G71,G72,G73,G74
	global H81,H82,H83,H84,I91,I92,I93,I94
	global J10_1,J10_2,J10_3,J10_4
	global K11_1,K11_2,K11_3,K11_4
...
def transform():
	global x,x11,x12,x13,x14
	global x21,x22,x23,x24,x31,x32,x33,x34
	global x41,x42,x43,x44,x51,x52,x53,x54
	global x71,x72,x73,x74,x81,x82,x83,x84
	global x91,x92,x93,x94,x101,x102,x103,x104
	global x111,x112,x113,x114
...
def graphics():
	global fig,ax,fig2,ax2,fig3,ax3,fig4,ax4,fig5,ax5
	global fig6,ax6,fig7,ax7,fig8,ax8,fig9,ax9,fig10,ax10
	...
	for i in range(0,4,1):
		...
		ax2[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax3[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax4[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax5[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax6[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax7[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax8[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax9[i].yaxis.set_minor_locator(tck.AutoMinorLocator())
		...
		ax10[i].yaxis.set_minor_locator(tck.AutoMinorLocator())

def plot():
	global line11,line12,line13,line14,line21,line22,line23,line24
	global line31,line32,line33,line34,line41,line42,line43,line44
	global line51,line52,line53,line54,line71,line72,line73,line74
	global line81,line82,line83,line84,line91,line92,line93,line94
	global line101,line102,line103,line104,line61,line62,line63,line64

	line11,=ax[0].plot(x11,A11,linewidth=0.85,ls='steps-post',color='b',label='A1-Blue')
	line12,=ax[1].plot(x12,A12,linewidth=0.85,ls='steps-post',color='k',label='A1-Black')
	line13,=ax[2].plot(x13,A13,linewidth=0.85,ls='steps-post',color='g',label='A1-Green')
	line14,=ax[3].plot(x14,A14,linewidth=0.85,ls='steps-post',color='r',label='A1-Red')
	#ax[4].plot(x[xlow:xup],A1[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='A1-addback')
	line101,=ax10[0].plot(x111,K11_1,linewidth=0.85,ls='steps-post',color='b',label='K11-Blue')
	line102,=ax10[1].plot(x112,K11_2,linewidth=0.85,ls='steps-post',color='k',label='K11-Black')
	line103,=ax10[2].plot(x113,K11_3,linewidth=0.85,ls='steps-post',color='g',label='K11-Green')
	line104,=ax10[3].plot(x114,K11_4,linewidth=0.85,ls='steps-post',color='r',label='K11-Red')
	#ax10[4].plot(x[xlow:xup],K11[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='K11-addback')
	line21,=ax2[0].plot(x21,B21,linewidth=0.85,ls='steps-post',color='b',label='B2-Blue')
	line22,=ax2[1].plot(x22,B22,linewidth=0.85,ls='steps-post',color='k',label='B2-Black')
	line23,=ax2[2].plot(x23,B23,linewidth=0.85,ls='steps-post',color='g',label='B2-Green')
	line24,=ax2[3].plot(x24,B24,linewidth=0.85,ls='steps-post',color='r',label='B2-Red')
	#ax2[4].plot(x[xlow:xup],B2[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='B2-addback')
	line31,=ax3[0].plot(x31,C31,linewidth=0.85,ls='steps-post',color='b',label='C3-Blue')
	line32,=ax3[1].plot(x32,C32,linewidth=0.85,ls='steps-post',color='k',label='C3-Black')
	line33,=ax3[2].plot(x33,C33,linewidth=0.85,ls='steps-post',color='g',label='C3-Gree')
	line34,=ax3[3].plot(x34,C34,linewidth=0.85,ls='steps-post',color='r',label='C3-Red')
	#ax3[4].plot(x[xlow:xup],C3[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='C3-addback')
	line41,=ax4[0].plot(x41,D41,linewidth=0.85,ls='steps-post',color='b',label='D4-Blue')
	line42,=ax4[1].plot(x42,D42,linewidth=0.85,ls='steps-post',color='k',label='D4-Black')
	line43,=ax4[2].plot(x43,D43,linewidth=0.85,ls='steps-post',color='g',label='D4-Green')
	line44,=ax4[3].plot(x44,D44,linewidth=0.85,ls='steps-post',color='r',label='D4-Red')
	#ax4[4].plot(x[xlow:xup],D4[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='D4-addback')
	line51,=ax5[0].plot(x51,E51,linewidth=0.85,ls='steps-post',color='b',label='E5-Blue')
	line52,=ax5[1].plot(x52,E52,linewidth=0.85,ls='steps-post',color='k',label='E5-Black')
	line53,=ax5[2].plot(x53,E53,linewidth=0.85,ls='steps-post',color='g',label='E5-Green')
	line54,=ax5[3].plot(x54,E54,linewidth=0.85,ls='steps-post',color='r',label='E5-Red')
	#ax5[4].plot(x[xlow:xup],E5[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='E5-addback')
	line61,=ax6[0].plot(x71,G71,linewidth=0.85,ls='steps-post',color='b',label='G7-Blue')
	line62,=ax6[1].plot(x72,G72,linewidth=0.85,ls='steps-post',color='k',label='G7-Black')
	line63,=ax6[2].plot(x73,G73,linewidth=0.85,ls='steps-post',color='g',label='G7-Green')
	#ax6[4].plot(x[xlow:xup],G7[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='G7-addback')
	line64,=ax6[3].plot(x74,G74,linewidth=0.85,ls='steps-post',color='r',label='G7-Red')
	line71,=ax7[0].plot(x81,H81,linewidth=0.85,ls='steps-post',color='b',label='H8-Blue')
	line72,=ax7[1].plot(x82,H82,linewidth=0.85,ls='steps-post',color='k',label='H8-Black')
	line73,=ax7[2].plot(x83,H83,linewidth=0.85,ls='steps-post',color='g',label='H8-Green')
	line74,=ax7[3].plot(x84,H84,linewidth=0.85,ls='steps-post',color='r',label='H8-Red')
	#ax7[4].plot(x[xlow:xup],H8[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='H8-addback')
	line81,=ax8[0].plot(x91,I91,linewidth=0.85,ls='steps-post',color='b',label='I9-Blue')
	line82,=ax8[1].plot(x92,I92,linewidth=0.85,ls='steps-post',color='k',label='I9-Black')
	line84,=ax8[3].plot(x94,I94,linewidth=0.85,ls='steps-post',color='r',label='I9-Red')
	#ax8[4].plot(x[xlow:xup],I9[xlow:xup],linewidth=0.85,ls='steps-post',color='red',label='I9-addback')
	line83,=ax8[2].plot(x93,I93,linewidth=0.85,ls='steps-post',color='g',label='I9-Green')
	line91,=ax9[0].plot(x101,J10_1,linewidth=0.85,ls='steps-post',color='b',label='J10-Blue')
	line92,=ax9[1].plot(x102,J10_2,linewidth=0.85,ls='steps-post',color='k',label='J10-Black')
	line93,=ax9[2].plot(x103,J10_3,linewidth=0.85,ls='steps-post',color='g',label='J10-Green')
	line94,=ax9[3].plot(x104,J10_4,linewidth=0.85,ls='steps-post',color='r',label='J10-Red')
...
def fitconnect():
	...
	global p51,p52,p53,p54,p71,p72,p73,p74
	global p81,p82,p83,p84,p91,p92,p93,p94
	global p101,p102,p103,p104,p61,p62,p63,p64
