...
#./2Dcut.py file 5000 5000 0 4999 0 4999 
#C. Wibisono
...
print("Hit e to expand axis (currently only work for zooming figure1")
print("Hit f to generate coordinates useful formaking banana gates")
...
def onpress(event):
	...
	if event.key == 'g':
		...
		if int(proj) == 2:
			...
			axp.plot(x,yproj,linewidth=0.75,ls='steps')
	if event.key == 'n':
		plt.figure(2)
